...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "mongodb+srv://userbot:userbot@cluster0.ltasu.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6885162066").split()):
        ADMINS.append(int(x))
except ValueError:
